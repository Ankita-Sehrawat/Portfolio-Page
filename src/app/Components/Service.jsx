        ...
        <div className='flex flex-wrap justify-center sm:mx-5 lg:mx-10 '>
          {ServiceArr.map((item, i) => {
            return (
              <div
                key={i}
                className="max-[450px]:w-full w-11/12 md:w-6/12 sm:px-[10px] lg:px-5 "
              >
                <div className="max-[450px]:p-0 p-[15px_20px] lg:p-[20px_40px] xl:p-[30px_40px] h-full flex flex-col justify-between ">
                  <h1 className="max-[450px]:text-5xl text-[55px] md:text-[60px] lg:text-[70px] font-normal text-white/80 ff_roadRage mb-2 xl:mb-5  leading-[50px] lg:leading-[77px] mt-3 sm:mt-0 ">
                    {item.num}{" "}
                  </h1>
                  <p className="font-semibold max-[450px]:text-xl text-2xl lg:text-[32px] text-white mb-2 xl:mb-5 ">
                    {item.title}
                  </p>
